...
class CompressedMatrixOperations:
    ...
    def matrix_matrix_mult(treeNodeA: TreeNode, treeNodeB: TreeNode) -> TreeNode:
        ...
        if not treeNodeA.children and treeNodeB.children:
            ...
            C1 = CompressedMatrixOperations.matrix_matrix_add(CompressedMatrixOperations.matrix_matrix_mult(A11, B1),
                                                              CompressedMatrixOperations.matrix_matrix_mult(A12, B3))
            C2 = CompressedMatrixOperations.matrix_matrix_add(CompressedMatrixOperations.matrix_matrix_mult(A11, B2),
                                                              CompressedMatrixOperations.matrix_matrix_mult(A12, B4))
            C3 = CompressedMatrixOperations.matrix_matrix_add(CompressedMatrixOperations.matrix_matrix_mult(A13, B1),
                                                              CompressedMatrixOperations.matrix_matrix_mult(A14, B3))
            C4 = CompressedMatrixOperations.matrix_matrix_add(CompressedMatrixOperations.matrix_matrix_mult(A13, B2),
                                                              CompressedMatrixOperations.matrix_matrix_mult(A14, B4))
        ...
        if treeNodeA.children and not treeNodeB.children:
            ...
            C1 = CompressedMatrixOperations.matrix_matrix_add(CompressedMatrixOperations.matrix_matrix_mult(A1, B11),
                                                              CompressedMatrixOperations.matrix_matrix_mult(A3, B12))
            C2 = CompressedMatrixOperations.matrix_matrix_add(CompressedMatrixOperations.matrix_matrix_mult(A2, B11),
                                                              CompressedMatrixOperations.matrix_matrix_mult(A4, B12))
            C3 = CompressedMatrixOperations.matrix_matrix_add(CompressedMatrixOperations.matrix_matrix_mult(A1, B13),
                                                              CompressedMatrixOperations.matrix_matrix_mult(A3, B14))
            C4 = CompressedMatrixOperations.matrix_matrix_add(CompressedMatrixOperations.matrix_matrix_mult(A2, B13),
                                                              CompressedMatrixOperations.matrix_matrix_mult(A4, B14))
